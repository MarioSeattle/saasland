                    ...
                    <div class="col-lg-6 col-sm-12">
                        <div class="section_one_img">
                            ...
                            <?php if ( $featured_img['featured_image']['url'] ) : ?>
                                <img src="<?php echo esc_url( $featured_img['featured_image']['url']); ?>" alt="<?php echo esc_attr($featured_img['alt']) ?>">
                            <?php endif; ?>
                            <?php if ( $featured_img['another_featured_image']['url'] ) : ?>
                            <img class="p_absoulte phon_img" src="<?php echo esc_url( $featured_img['another_featured_image']['url']); ?>" alt="<?php echo esc_attr($featured_img['alt']) ?>">
                            <?php endif; ?>
                        </div>
                    </div>
